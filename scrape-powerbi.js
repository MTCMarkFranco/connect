...
(async () => {
  ...
  // Encode the screenshot as base64 for the multi-modal prompt
  const screenshotBase64 = fs.readFileSync(SCREENSHOT_FILE).toString("base64");
    ...
    messages: [
      {
        role: "system",
        content:
          "You are a business analyst. The user will provide raw text and a screenshot image from a Power BI quarterly performance report. " +
          "Use both the text and the image to extract every visible metric, KPI, and data point. " +
